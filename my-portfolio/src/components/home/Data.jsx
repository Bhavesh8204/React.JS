...
function Data() {
    return (
        <div className="home_data">
            <h1 className="home_title">Bhavesh
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">I'm creative front-end devloper based in ahmedabad, and I'm very passionate and dedicated to my work.</p>
